...
<!-- iFrame - Directly from Tinychat -->
	<?php 
		echo '<div id="content">
		<iframe src="https://tinychat.com/'.$name.'" name="room" frameborder="0" scrolling="no" height="100%" width="100%" allow="geolocation; microphone; camera;"></iframe>
		</div>';
	}
		}
			}
